...
def sds_product_id_to_sensor(sds_product_id: str):
    ...
    if "-S1A" in sds_product_id:
        return "SENTINEL"
    if "-S1B" in sds_product_id:
        return "SENTINEL"
    elif "-S2A" in sds_product_id:
        return "SENTINEL"
    elif "-S2B" in sds_product_id:
        return "SENTINEL"
    elif "-L8" in sds_product_id:
        return "LANDSAT"
    elif "-L9" in sds_product_id:
        return "LANDSAT"
    else:
